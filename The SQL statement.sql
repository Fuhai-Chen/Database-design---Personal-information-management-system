...
CREATE TABLE `person` (
  ...
  PRIMARY KEY (`姓名`)	/* 主键约束 */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户信息表'	/* 表格注释 */
...
CREATE TABLE `communication` (
  ...
  PRIMARY KEY (`姓名`)	/* 主键约束 */
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='通讯录记录表'
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='日记记录表'
